...
chairs = imread('/media/DATAPART1/oakland/earthmine/rect_hires/37.794703,-122.257721-0002.jpg');
imshow(chairs); hold on;
tic
lines = lsd(double(chairs));
%print '-depsc', lines
print '-depsc', size(lines)
print '-depsc', max(lines)
print '-depsc', min(lines)
print '-depsc', mean(lines)
