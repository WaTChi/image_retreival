...
def constrainedEssMatrix(matches, wRd, wRq, qYaw=np.nan, runflag=5, maxerr=.05, maxiter=1000):
    ...
    if runflag == 4: # qYaw unknown
        nprm, nrand = 3, 3
        compE, lsqE, errE = compE_tq, lsqE_tq, errE_tq
    else: # runflag == 5: qYaw known
        nprm, nrand = 2, 2
