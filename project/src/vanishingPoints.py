...
def VPfromLSD(imgpath,Kcal='default'):
    pass

def linesFromLSD(imgpath):

def callLSD(imgpath,outpath):
    pass
#
#
#    """
...
#
#
#    imageDouble = lsd.new_image_double_s(img, width, length) #  imageAsDoubleArray, width, length)
#
#    print "imageDouble: ", imageDouble
#
#    imageAsDoubleArray = lsd.new_image_double_s(width*length)
#
#    start = time.time()
#
#    #coppies data to C's (double *) type, waste of time, find better way
