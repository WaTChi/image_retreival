...
#                  # STRICT ELIMINATION #
C.pose_param = {
    'resultsdir'    : '/media/DATAPART2/ah/pose_runs/berkeley-cheat',
    'run_info'      : '/media/DATAPART2/ah/pose_runs/berkeley-cheat/run_info.txt',
    'pose_file'     : '/media/DATAPART2/ah/pose_runs/berkeley-cheat/pose_results.txt',
    'extras_file'   : '/media/DATAPART2/ah/pose_runs/berkeley-cheat/extras.txt',
    'cheat'         : True,
    'runflag'       : 11,
    'remove_ground' : False,
    'use_weight'    : True,
...
# SUBSELECTIONS
#C.selection = ['2011-04-04_15-16-24_729']
#C.selection = ['2011-04-04_15-42-43_581']
#C.selection = ['2011-04-04_15-32-55_864']
#C.selection = ['2011-04-04_15-06-48_388']
#C.selection = ['2011-04-04_15-09-15_376']
#C.selection = ['2011-04-04_15-17-45_763']
#C.selection = ['2011-04-04_15-22-31_544']
#C.selection = ['2011-04-04_15-23-24_958']
#C.selection = ['2011-04-04_14-58-32_697']
