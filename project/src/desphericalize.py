...
if __name__ == '__main__':
    PANORAMA_DIR = '/media/DATAPART2/Research/collected_images/earthmine-oakland/oakland_sphericals'
    OUTPUT_DIR = '/media/DATAPART2/Research/collected_images/earthmine-oakland/oakland_rect'
    SPREADSHEET = '/media/DATAPART2/Research/collected_images/earthmine-oakland/oakland_spherical_metadata.csv'
    HIRES_VIEWS = False
    if HIRES_VIEWS:
