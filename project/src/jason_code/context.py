...
class _Query:
  ...
  def check(self):
    self.jpgpath = self.jpgpath[0:-3] + 'jpg'
...
class _Context(object):
  ...
  def __init__(self, context=None):
    ...
    self.maindir = os.path.expanduser('~/Desktop/query/project/src/jason_code/')
    self.resultsdir = os.path.expanduser('~/Desktop/query/project/src/jason_code/topmatches/')
    self.reproj_file = os.path.expanduser('~/Desktop/query/project/src/jason_code/topmatches/reproj/')
...
#      )
  ...
  def dbdir(self):
    ...
    return os.path.join(self.maindir, 'cory_pose_db/cells-100/0,0')
  ...
  def matchdir(self):
    ...
    #return '/home/jason/Desktop/query/project/src/jason_code/cory_pose_db/cells-100/0,0'
