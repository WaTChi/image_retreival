...
for k=1:nq
    ...
    gt = getGT(query(k),method.set,gtDir,f139);
    ...
    for cg=cellgroups
        ...
        [cand,cand_vote,cand_lat,cand_lon] = getCand(cg.idx,query(k),vDir,qLat);
        ncand = length(cand);
        ...
        for j=1:cg.npts
            ...
            [cand_nres,~,s] = rankNcand(cand,param,method,ncand,ntop);
