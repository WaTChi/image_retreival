...
% train classifier
classifier = train(train_features,train_class,dists);

% test classifier on training and testing samples
[train_class_pred,train_condP] = classify(train_features,classifier);
[test_class_pred,test_condP] = classify(test_features,classifier);